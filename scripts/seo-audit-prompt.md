...
1. `data/franchises.ts` (The core data layer)
2. `data/projects.ts` (The dynamic content layer)
3. `pages/Home.tsx` (The render logic)
4. `components/seo/LocalBusinessSchema.tsx` (The technical signals)
5. `components/seo/PageMeta.tsx` (The meta tags)

## AUDIT CHECKLIST

### 1. The "Uniqueness" Test (CRITICAL)
* **Analyze `data/franchises.ts`:**
...
* **Analyze `components/seo/LocalBusinessSchema.tsx`:**
...
* **Analyze `components/seo/PageMeta.tsx`:**
