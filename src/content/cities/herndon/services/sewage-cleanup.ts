...
export const herndonSewageCleanupContent = {
  ...
  processSection: {
    headline: "Our Herndon Sewage Cleanup Protocol",
    steps: [
      {
        number: 1,
    ...
    types: [
      {
        ...
        description: "The most disruptive Herndon sewage emergency: tree roots, grease, or collapsed sections obstruct a shared lateral serving four to six homes. A complete blockage during morning peak produces simultaneous backup in three or four units within thirty minutes. Most 1980s installations lack backflow preventers, leaving every connected home vulnerable.",
      ...
      },
      {
        ...
        description: "Several properties along Elden Street were originally apartments with commercial plumbing. After condo conversion, cast iron horizontals connect to residential-spec PVC risers with different expansion rates producing joint separation. Individual modifications overload shared horizontals never upsized for condo renovation fixture counts.",
    ...
    hazards: [
      {
        ...
        description: "Backup through a shared lateral contains combined waste from every connected household — a broader pathogen profile than single-family events. Each household contributes its own bacterial, viral, and parasitic organisms. The diversity increases the probability occupants encounter pathogens their immune systems have never faced.",
      ...
      },
      {
        ...
        description: "Sewage saturating one side of a shared wall wicks through gypsum board and framing to the adjacent unit. The neighbor sees no visible sewage yet has pathogen-laden moisture permeating their drywall. Families continue occupying homes unaware of active biological contamination behind their walls.",
      ...
      },
      {
        ...
        description: "A forty-year-old galvanized pipe harbors decades of bacterial biofilm — dense microorganism colonies embedded in organic material and iron corrosion products. When corroded sections fail, this concentrated biofilm releases with pathogen loads significantly exceeding fresh sewage. The gelatinous material adheres to surfaces more tenaciously than liquid sewage.",
        risk: "Very high — concentrated pathogen load exceeding fresh sewage by orders of magnitude"
      },
      {
        hazard: "HVAC Cross-Contamination Between Attached Units",
        description: "Extraction equipment creating negative pressure in one unit pulls contaminated air through electrical penetrations, plumbing chases, and unsealed party wall joints into the adjacent home's HVAC return. Without coordinated pressure management, extraction in one home actively contaminates another.",
  ...
  serviceAreaSection: {
    headline: "Sewage Cleanup Throughout Herndon",
    neighborhoods: [
      "Downtown Herndon",
      "Fox Mill",
      "Worldgate",
