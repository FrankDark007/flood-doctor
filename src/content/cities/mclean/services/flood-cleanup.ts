...
McLean flood events operate on a different scale than standard residential water damage. A 4,000-square-foot finished basement with radiant-heated stone floors, hand-scraped hardwood, and rubber exercise flooring is not a weekend project with box fans and a rented dehumidifier. Thermal imaging after extraction routinely reveals moisture migration through plaster walls, beneath stone flooring where radiant tubing complicates access, and behind custom cabinetry that took months to install. Category 2 contamination from creek water escalates to Category 3 within 48 hours without immediate extraction and antimicrobial treatment — turning a restorable situation into a demolition project.`
    ...
    types: [
      {
        ...
        description: "Pimmit Run, Dead Run, and Scott Run creeks overtop their banks during intense storms, sending creek water carrying streambed sediment, organic debris, and upstream contaminants directly into walk-out lower levels. This is surface water entering through doors and windows at grade level, depositing inches of turbid water across finished spaces within minutes.",
      ...
      },
      {
        ...
        description: "McLean's clay-heavy soil builds hydrostatic pressure against foundations during extended rain. Water appears at floor-wall joints, weeps through hairline cracks, and seeps around pipe penetrations. A 4,000-square-foot basement can accumulate an inch of standing water in 24 hours through distributed seepage alone, saturating hardwood edges and wicking into drywall before the homeowner notices.",
        commonAreas: ["Salona Village", "McLean Hamlet", "Balls Hill", "Woodside Estates"]
      },
      {
        name: "Walk-Out Basement Door Ingress",
        description: "Hillside estates feature walk-out lower levels where grade-level French doors open onto stone patios. During intense storms, sheet flow overwhelms door thresholds designed for normal drainage. Patios act as collection surfaces, concentrating rainfall from the surrounding grade change. Homes with decorative drainage channels designed for aesthetics rather than storm capacity are most vulnerable.",
        commonAreas: ["Langley hillside estates", "The Reserve", "Evermay", "Clearspring Manor"]
      },
      {
        name: "Cascading Multi-Level Flooding",
        description: "In multi-level estates, water entering at walk-out grade flows through interior stairwells, elevator shafts, and utility chases to deeper basement zones. The home theater and wine cellar — situated below the walk-out floor for temperature stability — receive secondary flooding from above with water that has already picked up contaminants from the first level it crossed.",
      ...
      },
      {
        ...
        description: "McLean estates invest heavily in retaining walls, decorative drainage channels, and terraced gardens engineered for visual appeal and standard rainfall. When retaining walls saturate and weep, when terraced plantings direct sheet flow toward foundations, the landscaping becomes the flood delivery mechanism. Upstream infill development has increased impervious surface, sending more runoff through properties designed for pre-development drainage patterns.",
  ...
  contaminationSection: {
    ...
    categories: [
      {
        ...
        description: "Creek tributary water carries streambed sediment, dissolved organic matter, lawn treatment chemicals, and soil bacteria. It deposits fine alluvial silt that embeds in hardwood grain, fills stone grout lines, and coats surfaces with a film harboring bacterial colonies. The antimicrobial protocol for Italian marble differs fundamentally from engineered hardwood or acoustic panels. Grout absorbs contamination below the surface, requiring extraction at depth.",
      ...
      },
      {
        ...
        description: "Any flood water standing longer than 48 hours escalates to Category 3, and sewage-mixed water is Category 3 from contact. In McLean wine cellars with limited ventilation, bacterial proliferation accelerates — warm, still, humid conditions are ideal growth environments. Porous materials absorbing Category 3 water become biohazard waste: acoustic panels, carpet, upholstered furniture, paper-backed drywall. Containment barriers isolate Category 3 zones from adjacent clean spaces.",
    ...
    localNote: "Properties near Great Falls and along McLean's western edge often rely on private septic systems. During heavy rainfall and soil saturation, septic systems can backflow through floor drains, instantly converting Category 2 storm water intrusion into a full Category 3 biohazard event."
  },
  ...
  serviceAreaSection: {
    headline: "Flood Cleanup Throughout McLean",
    neighborhoods: [
      "Langley",
      "Chesterbrook",
      "The Reserve",
