...
export const greatfallsSewageCleanupContent: ServicePageContent = {
  meta: {
    ...
    canonical: "https://greatfalls.flood.doctor/services/residential/cleanup-services/sewage-cleanup/"
  },
...
Our IICRC Master Water Restorers and biohazard-certified crews understand that sewage cleanup in Great Falls means protecting irreplaceable assets while ensuring complete decontamination. Your wine cellar, your custom finishes, your family's health—all require the thoroughness and discretion we provide.`
  ...
  processSection: {
    headline: "Our Great Falls Sewage Cleanup Process",
    steps: [
      {
        number: 1,
  ...
  localChallenges: {
    headline: "Sewage & Septic Challenges in Great Falls Estates",
    challenges: [
      {
