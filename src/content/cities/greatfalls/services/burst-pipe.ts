// src/content/cities/greatfalls/services/burst-pipe.ts
// Generated: January 3, 2026
// Great Falls Burst Pipe Service Page - 100% Unique
...
export const greatfallsBurstPipeContent: ServicePageContent = {
  meta: {
...
Our IICRC Master Water Restorers understand the complexity of Great Falls estate plumbing. We trace water migration through multiple floors, identify damage in areas far from the burst, and coordinate with plumbers who specialize in high-end residential systems. One call handles everything—from emergency extraction to complete restoration.`
  ...
  processSection: {
    headline: "Our Great Falls Burst Pipe Emergency Response",
    steps: [
      {
        number: 1,
  ...
  localChallenges: {
    headline: "Burst Pipe Challenges in Great Falls Estates",
    challenges: [
      {
  ...
  finalCTA: {
    ...
    phone: "(703) 656-0112",
    buttonText: "Call Now - Stop the Damage"
  }
};
