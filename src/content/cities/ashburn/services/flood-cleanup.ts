...
That scenario plays out across Ashburn's post-2005 neighborhoods every storm season. Spray foam, house wrap, and vapor barriers create airtight envelopes designed to keep conditioned air inside — envelopes that also trap any moisture that breaches the exterior. Once water gets past the flashing and behind the foam, it can't evaporate outward through the vapor barrier or dry inward through the spray foam. It sits in the cavity, raising relative humidity to mold-supporting levels within 36 hours.`,
    ...
    types: [
      {
        ...
        description: "The most misdiagnosed flood type in Ashburn. Omitted kick-out flashing, improperly taped window pan flashing, and unsealed J-channel allow wind-driven rain to enter wall cavities. Water travels down studs behind insulation and appears at baseboards — mimicking a plumbing leak. Without fixing the flashing, the next wind-driven rain causes identical damage. We trace intrusion to the source and coordinate permanent repair.",
        commonAreas: ["Broadlands", "Brambleton", "One Loudoun"]
      },
      {
        name: "SWM Pond Overwhelm",
        description: "Ashburn's stormwater ponds were designed for specific return-period storms using hydrological models based on projected density and soil infiltration. Actual storms regularly exceed those parameters. When detention basins overflow, emergency spillways discharge into neighborhoods at grade. Some HOA-maintained bioswales have lost capacity to sediment accumulation, reducing effective volume further.",
        commonAreas: ["Stone Ridge", "Moorefield Station", "Ashburn Farm"]
      },
      {
        name: "LVP Concealed Pooling",
        description: "Luxury vinyl plank flooring — in virtually every post-2010 Ashburn home — is waterproof on the walking surface, which becomes a liability during flooding. Water flows through expansion gaps, migrates under the floating floor, and pools invisibly on the subfloor. Homeowners walk on dry-looking flooring while water sits underneath for days, providing ideal mold conditions. By the time musty odor reveals the problem, extensive growth may already be established.",
      ...
      },
      {
        ...
        description: "Modern Ashburn basements exceed 2,000 square feet with minimal interior walls. When water enters, it flows unimpeded across the entire lower level within minutes — no room boundaries to slow spreading or create natural containment. Any water event affects the maximum possible area.",
        commonAreas: ["All newer Ashburn subdivisions", "Homes with finished open-plan basements"]
      },
      {
        name: "Grinder Pump Community Backup",
        description: "Several Ashburn neighborhoods use pressure sewer systems where each home's grinder pump pushes waste to a community force main. During heavy storms, system pressure prevents individual pumps from discharging. Sewage backs up through basement floor drains, converting a clean storm event into Category 3 biohazard requiring full contamination protocols.",
  ...
  contaminationSection: {
    ...
    categories: [
      {
        ...
        description: "Ashburn's storm runoff carries construction sediment from active sites, concentrated fertilizer from new landscaping, and nutrient-loaded overflow from SWM ponds. Builder-grade materials absorb contamination rapidly — thin carpet padding saturates through its full thickness. Where contaminated water contacts concrete beneath LVP flooring, bacterial cultures establish on the porous surface within 24 hours.",
      ...
      },
      {
        ...
        description: "Sealed-envelope construction accelerates contamination escalation. Moisture trapped inside spray foam assemblies reaches mold-supporting humidity — above 60% RH — within 24 to 36 hours, roughly half the window in conventional construction. The tight building envelope prevents natural drying and creates concealed incubation chambers. Category 3 protocols require opening wall assemblies that cannot be dried through their surfaces.",
    ...
    localNote: "Flashing-failure floods are uniquely dangerous because they introduce exterior contamination directly into concealed wall cavities. Even small-volume intrusion creates concealed Category 2 conditions inside assemblies that look dry from the living space. Any history of unexplained musty odor after wind-driven rain warrants investigation."
  },
