...
export const CITIES: Record<string, CityConfig> = {
  ...
  'great-falls': {
    ...
    name: 'Great Falls',
    state: 'VA',
    subdomain: 'greatfalls.flood.doctor',
    responseTime: '30-40 min',
    headline: 'Water Damage Restoration in Great Falls, Virginia',
    description: "Great Falls premium water damage restoration. Estate-scale response for custom homes. 30-40 minute response. IICRC certified.",
    neighborhoods: [
      { name: 'Great Falls Village', time: '30-35 min' },
      { name: 'River Bend', time: '30-35 min' },
      { name: 'Forestville', time: '30-40 min' },
      { name: 'Seneca Knolls', time: '35-40 min' },
    ],
    localChallenges: [
      'Estate-scale properties spanning 8,000-15,000+ square feet',
      'Custom millwork, imported stone, and specialty hardwoods',
      'Well and septic system failures',
      'Wooded lots with drainage challenges',
    ],
    testimonials: [
      {
        quote: "They understood our custom finishes and treated our home with exceptional care. Professional service from start to finish.",
        author: "The Wellington Family",
        location: "Great Falls"
      }
    ],
    geo: { lat: 39.0018, lng: -77.2886 },
    zipCodes: ['22066'],
  },
  bethesda: {
    slug: 'bethesda',
    name: 'Bethesda',
    state: 'MD',
    subdomain: 'bethesda.flood.doctor',
    responseTime: '40-55 min',
    headline: 'Water Damage Restoration in Bethesda, Maryland',
    description: "Bethesda water damage restoration. Premium service for downtown Bethesda, Chevy Chase, and Bradley Hills. Licensed in Maryland.",
    neighborhoods: [
      { name: 'Downtown Bethesda', time: '40-50 min' },
      { name: 'Chevy Chase', time: '45-55 min' },
      { name: 'Bradley Hills', time: '40-50 min' },
      { name: 'Burning Tree', time: '40-50 min' },
      { name: 'Kenwood', time: '45-55 min' },
      { name: 'Wood Acres', time: '40-50 min' },
    ],
    localChallenges: [
      'Historic and premium properties with custom finishes',
      'High-rise condo and residential tower coordination',
      'Older established neighborhoods with aging plumbing',
      'Premium real estate requiring careful restoration',
    ],
    testimonials: [],
    geo: { lat: 38.9807, lng: -77.0886 },
  ...
  potomac: {
    ...
    name: 'Potomac',
    state: 'MD',
    subdomain: 'potomac.flood.doctor',
    responseTime: '40-55 min',
    headline: 'Water Damage Restoration in Potomac, Maryland',
    description: "Potomac premium water damage restoration. Serving Potomac Village, Avenel, and all Potomac estates. 40-55 minute response.",
    neighborhoods: [
      { name: 'Potomac Village', time: '40-50 min' },
      { name: 'Avenel', time: '40-50 min' },
      { name: 'Potomac Falls', time: '45-55 min' },
      { name: 'Glen Echo Heights', time: '40-50 min' },
    ],
    localChallenges: [
      'Estate-scale properties spanning 6,000-15,000+ square feet',
      'Custom and luxury finishes requiring specialized care',
      'Wooded lots with terrain and drainage challenges',
      'Private water and septic systems',
    ],
    testimonials: [],
    geo: { lat: 39.0182, lng: -77.2086 },
    zipCodes: ['20854', '20859'],
  },
  rockville: {
    slug: 'rockville',
    name: 'Rockville',
    state: 'MD',
    subdomain: 'rockville.flood.doctor',
    responseTime: '45-60 min',
    headline: 'Water Damage Restoration in Rockville, Maryland',
    description: "Rockville water damage restoration. Serving Downtown Rockville, Rockville Town Center, and all Rockville neighborhoods. Maryland licensed.",
    neighborhoods: [
      { name: 'Rockville Town Center', time: '45-55 min' },
      { name: 'Downtown Rockville', time: '45-55 min' },
      { name: 'Twinbrook', time: '50-60 min' },
      { name: 'Fallsgrove', time: '50-60 min' },
      { name: 'King Farm', time: '50-60 min' },
    ],
    localChallenges: [
      'Mix of urban condos and suburban homes',
      'Aging infrastructure in older neighborhoods',
      'Commercial and residential mixed-use areas',
      'Properties near Rock Creek with flood risk',
    ],
    testimonials: [],
    geo: { lat: 39.0840, lng: -77.1528 },
  ...
  'silver-spring': {
    ...
    name: 'Silver Spring',
    state: 'MD',
    subdomain: 'silverspring.flood.doctor',
    responseTime: '45-60 min',
    headline: 'Water Damage Restoration in Silver Spring, Maryland',
    description: "Silver Spring water damage restoration. Serving Downtown Silver Spring, Takoma Park, and all surrounding neighborhoods. Licensed in MD.",
    neighborhoods: [
      { name: 'Downtown Silver Spring', time: '45-55 min' },
      { name: 'Takoma Park', time: '50-60 min' },
      { name: 'Wheaton', time: '55-65 min' },
      { name: 'Four Corners', time: '50-60 min' },
      { name: 'White Oak', time: '55-65 min' },
    ],
    localChallenges: [
      'Dense urban development with multi-family buildings',
      'Older homes with aging plumbing systems',
      'Combined sewer system backup risks',
      'Properties near Sligo Creek with flood exposure',
    ],
    testimonials: [],
    geo: { lat: 38.9907, lng: -77.0261 },
    zipCodes: ['20901', '20902', '20903', '20904', '20905', '20906', '20910', '20912'],
  },
};
