...
export const SERVICES: ServiceData[] = [
  ...
  // 1. Odor Removal
  {
    ...
    heroIntro: 'Professional smoke odor removal, pet odor elimination, and musty smell treatment. Hydroxyl generators, thermal fogging, ozone treatment, and fire odor deodorization services.',
  ...
  // 2. Water Damage Restoration
  {
    ...
    heroIntro: '24/7 emergency water extraction, structural drying, and water damage repair. IICRC-certified water mitigation specialists with 60-minute response and direct insurance billing.',
  ...
  // 3. Fire & Smoke Cleanup
  {
    ...
    heroIntro: 'Emergency smoke damage cleanup, soot removal, fire odor elimination, and structural fire damage repair. IICRC-certified house fire restoration with content cleaning and insurance claim assistance.',
  ...
  // 4. Contents Cleaning & Pack-out
  {
    ...
    heroIntro: 'Professional contents restoration and pack-out services for water damaged furniture, electronics, and documents. Personal property cleaning, secure storage, and return — save 60–80% versus replacement.',
  ...
  // 5. Basement Flooding
  {
    ...
    heroIntro: 'Emergency basement water removal, sump pump failure cleanup, and flooded basement restoration. Professional basement water extraction, structural drying, and mold prevention — 24/7 response.',
  ...
  // 6. Crawl Space Drying
  {
    ...
    heroHeading: 'Crawl Space Drying & Moisture Control',
    heroIntro: 'Professional crawl space water removal, moisture control, and crawl space encapsulation. Standing water extraction, wet insulation removal, crawl space mold prevention, and dehumidification services.',
  ...
  // 7. Hardwood Floor Drying
  {
    ...
    heroIntro: 'Hardwood floor water damage repair using injection mat drying systems. Save cupping and buckling hardwood floors without removal. Professional wood floor restoration and water damaged flooring repair.',
  ...
  // 8. Roof Leak Water Damage
  {
    ...
    heroIntro: 'Roof leak water damage repair, ceiling leak restoration, and attic water damage cleanup. Emergency roof tarping, wet insulation removal, and interior storm damage restoration.',
  ...
  // 9. Flood Cleanup
  {
    ...
    heroHeading: 'Flood Damage Cleanup',
    heroIntro: 'Emergency flood water removal, storm flood cleanup, and flood damage repair. Industrial flood extraction equipment, basement flood restoration, and hurricane damage cleanup with direct insurance billing.',
  ...
  // 10. Sewage Cleanup
  {
    ...
    heroIntro: 'Emergency sewage backup cleanup, black water extraction, and biohazard remediation. Septic overflow restoration, basement sewage removal, and hospital-grade sanitization with Category 3 water damage protocols.',
  ...
  // 11. Mold Remediation
  {
    ...
    heroHeading: 'Mold Remediation',
    heroIntro: 'Professional mold removal, black mold remediation, and mold inspection services. Complete containment, mold testing, basement and attic mold cleanup, and post-remediation clearance testing.',
  ...
  // 12. Structural Drying
  {
    ...
    heroHeading: 'Structural Drying Services',
    heroIntro: 'IICRC-certified structural drying with commercial dehumidification, wall cavity drying, and subfloor moisture removal. Professional drying equipment and advanced moisture detection — 3–5 day completion.',
  ...
  // 13. Storm Damage Restoration
  {
    ...
    heroIntro: 'Emergency storm damage repair, wind and hail damage restoration, and tree damage cleanup. Roof storm damage tarping, emergency board-up, and hurricane damage restoration — 24/7 emergency response.',
  ...
  // 14. Burst Pipe Cleanup
  {
    ...
    heroHeading: 'Burst Pipe Cleanup Services',
    heroIntro: 'Emergency burst pipe water damage cleanup, frozen pipe repair, and pipe burst restoration. High-capacity water extraction, supply line break repair, and emergency plumbing water damage mitigation — 60-minute response.',
