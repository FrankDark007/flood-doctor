...
export const SERVICES: ServiceData[] = [
  ...
  // 1. Odor Removal
  {
    ...
    shortDescription: 'Professional smoke, pet, mold, and sewage odor elimination using hydroxyl, ozone, and thermal fogging. IICRC-certified technicians with 60-minute response and direct insurance billing.',
  ...
  // 2. Water Damage Restoration
  {
    ...
    shortDescription: '24/7 emergency water extraction, structural drying, and water damage repair. IICRC-certified water mitigation specialists with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    ...
    heroHeading: 'Water Damage Restoration in Fairfax & Northern Virginia',
  ...
  // 3. Fire & Smoke Cleanup
  {
    ...
    shortDescription: '24/7 fire damage restoration, soot removal, and smoke odor elimination for homes. IICRC-certified fire restoration specialists with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'CLEANUP',
  ...
  // 4. Contents Cleaning & Pack-out
  {
    ...
    shortDescription: 'Professional contents cleaning, pack-out, and restoration for furniture, electronics, and personal belongings after water or fire damage. Inventory-tracked with direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'CLEANUP',
  ...
  // 5. Basement Flooding
  {
    ...
    shortDescription: '24/7 basement water removal, extraction, and drying after flooding or sump pump failure. IICRC-certified technicians with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'SPECIALTY',
  ...
  // 6. Crawl Space Drying
  {
    ...
    shortDescription: 'Professional crawl space water removal, dehumidification, and encapsulation to stop mold, rot, and moisture damage. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'SPECIALTY',
  ...
  // 7. Hardwood Floor Drying
  {
    ...
    shortDescription: 'Specialized hardwood floor drying for cupping, buckling, and water damage using injection and negative-pressure systems. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'SPECIALTY',
  ...
  // 8. Roof Leak Water Damage
  {
    ...
    shortDescription: '24/7 roof leak water damage repair for ceilings, attics, and walls with emergency tarping and structural drying. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'SPECIALTY',
  ...
  // 9. Flood Cleanup
  {
    ...
    shortDescription: '24/7 emergency flood cleanup with contaminated water extraction, drying, and sanitization after storms or flooding. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'RESTORATION',
    ...
    heroHeading: 'Emergency Flood Cleanup & Flood Damage Restoration in Northern Virginia',
    heroIntro: 'Flood damage devastates Northern Virginia homes every year. Spring storms, summer hurricanes, frozen pipe bursts, and sudden plumbing failures send thousands of gallons of water into basements, living spaces, and commercial properties. Flood Doctor provides emergency flood cleanup throughout Fairfax County, Northern Virginia, Washington DC, and Maryland. Our IICRC-certified technicians respond within 60 minutes—24/7/365—with industrial extraction equipment and 25+ years of experience. Direct insurance billing.',
  ...
  // 10. Sewage Cleanup
  {
    ...
    shortDescription: '24/7 sewage backup cleanup with biohazard containment, Category 3 decontamination, and antimicrobial treatment. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'CLEANUP',
  ...
  // 11. Mold Remediation
  {
    ...
    shortDescription: 'Professional mold inspection, testing, and black mold removal with HEPA containment and clearance verification. IICRC-certified remediation specialists with direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'CLEANUP',
  ...
  // 12. Structural Drying
  {
    ...
    shortDescription: '24/7 structural drying with wall cavity dehumidification, moisture monitoring, and documented drying logs. IICRC-certified technicians with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'RESTORATION',
    ...
    heroHeading: 'Professional Structural Drying Services in Fairfax & Northern Virginia',
    heroIntro: 'Water extraction is only half the battle after water damage. Even after standing water is removed, moisture remains trapped in drywall, studs, subfloors, and insulation. Without professional structural drying, hidden moisture leads to warped materials, wood rot, and mold growth within days. Flood Doctor provides IICRC-certified structural drying throughout Fairfax County, Northern Virginia, Washington DC, and Maryland. Our ASD-certified technicians use industrial dehumidifiers, high-velocity air movers, and advanced moisture detection. 3-5 day completion. Free assessment.',
  ...
  // 13. Storm Damage Restoration
  {
    ...
    shortDescription: '24/7 storm damage restoration with emergency board-up, tarping, water extraction, and full repairs. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'RESTORATION',
    ...
    heroHeading: '24/7 Emergency Storm Damage Restoration in Northern Virginia',
    heroIntro: 'When severe storms strike Northern Virginia, the damage can be devastating. High winds tear off roofing, driving rain floods homes, falling trees crush structures, and power outages leave properties vulnerable. Every hour of delay allows water to penetrate deeper, creating conditions for mold growth and structural deterioration. Flood Doctor provides 24/7 emergency storm damage restoration throughout Fairfax County, Northern Virginia, Washington DC, and Maryland. Our IICRC-certified technicians respond within 60 minutes—even during major storm events. Emergency tarping, board-up, water extraction, and complete restoration. Free inspection.',
  ...
  // 14. Burst Pipe Cleanup
  {
    ...
    shortDescription: '24/7 burst pipe and frozen pipe cleanup with emergency water extraction, drying, and plumbing coordination. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'RESIDENTIAL',
    category: 'RESTORATION',
    ...
    heroHeading: 'Emergency Burst Pipe Cleanup Services in Fairfax & Northern Virginia',
    heroIntro: 'A burst pipe releases hundreds of gallons of water per hour into your home. Within minutes, water spreads across floors, seeps through ceilings, and saturates walls. Within 24-48 hours, mold begins growing in damp areas. Every minute of delay increases damage and restoration costs. Flood Doctor provides 24/7 emergency burst pipe cleanup throughout Fairfax County, Northern Virginia, Washington DC, and Maryland. Our IICRC-certified technicians respond within 60 minutes—day or night—with high-capacity extraction equipment. Frozen pipe specialists. Free emergency assessment. Insurance claim assistance.',
  ...
  // 15. Commercial Water Damage
  {
    ...
    shortDescription: '24/7 commercial water damage restoration with rapid extraction and drying to minimize business downtime. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'RESTORATION',
  ...
  // 16. Commercial Flood Cleanup
  {
    ...
    shortDescription: '24/7 commercial flood cleanup for warehouses, offices, and retail with scalable extraction and drying equipment. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'RESTORATION',
  ...
  // 17. Large Loss Restoration
  {
    ...
    shortDescription: 'Large loss restoration for catastrophic water, fire, and storm events with dedicated project management and rapid mobilization. IICRC-certified with direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'RESTORATION',
  ...
  // 18. Commercial Sewage Cleanup
  {
    ...
    shortDescription: '24/7 commercial sewage cleanup with biohazard containment, OSHA-compliant decontamination, and discreet operations. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'CLEANUP',
  ...
  // 19. Commercial Mold Remediation
  {
    ...
    shortDescription: 'Commercial mold remediation with containment, removal, and clearance testing for tenant and regulatory compliance. IICRC-certified specialists with direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'CLEANUP',
  ...
  // 20. Commercial Fire Damage
  {
    ...
    shortDescription: '24/7 commercial fire damage restoration with soot cleanup, smoke odor removal, and rapid stabilization to reduce corrosion. IICRC-certified with direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'CLEANUP',
  ...
  // 21. Commercial Storm Damage
  {
    ...
    shortDescription: '24/7 commercial storm damage restoration with emergency board-up, tarping, and water extraction to protect inventory and assets. IICRC-certified with direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'RESTORATION',
  ...
  // 22. Commercial Roof Leak
  {
    ...
    shortDescription: '24/7 commercial roof leak restoration with interior drying, asset protection, and targeted extraction to minimize business disruption. IICRC-certified with direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'RESTORATION',
  ...
  // 23. Healthcare Facility Restoration
  {
    ...
    shortDescription: 'ICRA-compliant water and fire restoration for hospitals, clinics, and medical facilities with infection-control containment. IICRC-certified with direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'SPECIALTY',
  ...
  // 24. Hospitality Restoration
  {
    ...
    shortDescription: 'Discreet water damage restoration for hotels, restaurants, and multifamily properties with after-hours service and minimal guest impact. IICRC-certified with direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'SPECIALTY',
  ...
  // 25. Educational Facility Restoration
  {
    ...
    shortDescription: 'Water and fire restoration for schools, universities, and public buildings with safety-first scheduling to minimize class disruption. IICRC-certified with direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'SPECIALTY',
  ...
  // 26. Industrial Restoration
  {
    ...
    shortDescription: 'Industrial water damage restoration for factories and warehouses with high-capacity drying and equipment protection. IICRC-certified with 60-minute response and direct insurance billing.',
    audience: 'COMMERCIAL',
    category: 'SPECIALTY',
  ...
  // 27. Moisture Mapping (Technical)
  {
    ...
    shortDescription: 'Professional moisture mapping with thermal imaging and probe diagnostics to locate hidden water damage. Detailed reporting for precise drying and insurance documentation.',
    audience: 'COMMERCIAL',
    category: 'TECHNICAL',
  ...
  // 28. Indoor Air Quality (Technical)
  {
    ...
    shortDescription: 'Indoor air quality testing with mold spore sampling, particulate monitoring, and actionable IAQ reports. Certified testing to support remediation and occupant safety.',
    audience: 'COMMERCIAL',
    category: 'TECHNICAL',
  ...
  // 29. Environmental Testing (Technical)
  {
    ...
    shortDescription: 'Environmental testing for asbestos, lead paint, and hazardous materials with chain-of-custody sampling and compliance reporting. Licensed inspectors for safe restoration planning.',
    audience: 'COMMERCIAL',
    category: 'TECHNICAL',
