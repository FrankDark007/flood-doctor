  ...
  return (
    <section className="relative min-h-screen w-full bg-slate-900 text-white flex flex-col overflow-hidden">
      ...
      <header className="relative z-10 w-full border-b border-slate-700 bg-slate-900/50 backdrop-blur-sm p-4 flex justify-between items-center">
        <FadeIn direction="down" delay={0} className="w-full flex justify-between items-center">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center items-center p-4 md:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 w-full max-w-5xl mb-12">
          ...
          <FadeIn delay={100} direction="up" className="h-full">
            <div className="bg-slate-800 border border-slate-700 rounded-3xl p-6 relative overflow-hidden group hover:border-slate-600 transition-colors h-full">
          ...
          <FadeIn delay={200} direction="up" className="h-full">
            <div className="bg-slate-800 border border-slate-700 rounded-3xl p-6 flex flex-col justify-between group hover:border-slate-600 transition-colors h-full">
          ...
          <FadeIn delay={300} direction="up" className="h-full">
            <div className="bg-slate-800 border border-slate-700 rounded-3xl p-6 group hover:border-slate-600 transition-colors h-full">
               <div className="flex justify-between items-start mb-4">
          ...
          <FadeIn delay={400} direction="up" className="h-full">
            <div className="bg-slate-800 border border-slate-700 rounded-3xl p-6 flex flex-col justify-between relative overflow-hidden h-full">
