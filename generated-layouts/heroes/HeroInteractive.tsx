    ...
    <section className="relative min-h-screen w-full bg-white flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-xl mx-auto text-center">
        ...
        <FadeIn delay={200} direction="up">
          <div className="bg-white rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100 p-2 md:p-3 relative overflow-hidden transition-all duration-500">
        ...
        {status === 'idle' && (
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
            <FadeIn delay={400} direction="up" className="flex flex-col items-center gap-2 group cursor-default">
            ...
            <FadeIn delay={500} direction="up" className="flex flex-col items-center gap-2 group cursor-default">
              <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center group-hover:bg-blue-50 transition-colors">
            ...
            <FadeIn delay={600} direction="up" className="flex flex-col items-center gap-2 group cursor-default">
              <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center group-hover:bg-blue-50 transition-colors">
            ...
            <FadeIn delay={700} direction="up" className="flex flex-col items-center gap-2 group cursor-default">
              <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center group-hover:bg-blue-50 transition-colors">
