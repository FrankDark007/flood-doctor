...
- **2026-02-21**: P1 #4 Cost Calculator — extracted pricing data to typed module (`data/pricing/flood-doctor-rates.ts`). FloodDoctorPricing interface + currentPricing export. Schema dateModified now data-driven. Zero UI changes, identical calculator outputs.
