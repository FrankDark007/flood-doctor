...
const AllstateWaterDamageClaimGuide: React.FC = () => {
  ...
  return (
    <main className="flex-grow bg-white">
      <PageMeta
        title="Allstate Water Damage Claim Guide"
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-32 space-y-6">
              <div className="bg-indigo-600 rounded-[32px] p-8 text-white shadow-lg">
                ...
                <Button to="/request/" variant="secondary" fullWidth className="bg-white text-indigo-600 border-none hover:bg-indigo-50">
                  Request Services
                </Button>
