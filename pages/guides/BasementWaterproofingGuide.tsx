...
const BasementWaterproofingGuide: React.FC = () => {
  ...
  return (
    <main className="flex-grow bg-white">
      <PageMeta
        title="How to Waterproof Your Basement | Complete Guide | Flood Doctor"
      ...
      <div className="bg-gradient-to-r from-[#1a73e8] to-[#1557b0] py-16">
        <div className="max-w-[1440px] mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Button to="/services/basement-flooding/" variant="secondary" size="lg" className="bg-transparent text-white border-2 border-white hover:bg-white/10">
