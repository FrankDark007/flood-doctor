  ...
  return (
    <main className="flex-grow bg-white">
      <PageMeta
        ...
        description="Fast basement flood cleanup in Alexandria, VA. Emergency water extraction, drying & restoration for Old Town, Del Ray, Kingstowne & all Alexandria areas."
        schema={schema}
      />
