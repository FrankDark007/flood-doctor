...
const McLeanBasementFlooding: React.FC = () => {
  const locationSchema = generateLocationPageSchema(
    {
      name: 'McLean, VA',
      description: 'Expert basement flooding repair and waterproofing in McLean, VA. 24/7 emergency response, water extraction, structural drying serving Great Falls, Langley, Pimmit Hills. Call 703-665-0505.',
      address: {
  ...
  return (
    <main className="flex-grow bg-white">
      <PageMeta
        ...
        description="Expert basement flooding repair in McLean, VA. Emergency water extraction, structural drying, waterproofing. Serving Great Falls, Langley & Pimmit Hills. Call 703-665-0505."
