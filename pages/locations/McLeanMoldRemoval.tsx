...
const McLeanMoldRemoval: React.FC = () => {
  const locationSchema = generateLocationPageSchema(
    {
      name: 'McLean, VA',
      description: 'Professional mold removal and remediation in McLean, VA. EPA-approved methods, IICRC certified, serving Great Falls, Langley, Pimmit Hills, and Tysons. Call 703-665-0505.',
      address: {
  ...
  return (
    <main className="flex-grow bg-white">
      <PageMeta
        ...
        description="Professional mold removal and remediation in McLean, VA. EPA-approved methods, IICRC certified. Serving Great Falls, Langley, Pimmit Hills & Tysons. Call 703-665-0505."
