...
/**
 * HomeDevC - Editorial/Magazine Style
 *
 * Key patterns:
  ...
  return (
    <main className="flex-grow bg-white">
      <PageMeta
        ...
        description="24/7 water damage restoration serving Northern Virginia families. 60-minute response, direct insurance billing, locally owned."
      />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 lg:py-32 w-full">
          <div className="max-w-4xl">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-white/60 text-sm tracking-widest uppercase">Northern Virginia's Trusted Restoration Company</span>
            </div>

            <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-semibold text-white mb-8 leading-[0.95]">
              When water
              <br />
              <span className="italic font-normal">threatens</span> your home,
              <br />
              we're <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-primary">here.</span>
            </h1>

            <p className="text-xl lg:text-2xl text-white/60 mb-12 max-w-2xl leading-relaxed">
              24/7 emergency response. 60-minute arrival. Direct insurance billing.
              Restoring Northern Virginia homes since 2008.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="h-px w-12 bg-white/40" />
                <span className="text-white/60 text-sm tracking-widest uppercase">Our Community</span>
              </div>
              <h2 className="font-display text-3xl lg:text-5xl font-semibold mb-6">
                Proudly serving
                <br />
                <span className="italic font-normal">Northern Virginia</span>
              </h2>
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-display text-4xl lg:text-6xl font-semibold text-white mb-6 leading-tight">
            ...
            <br />
            <span className="italic font-normal">Neither should you.</span>
          </h2>
