...
/**
 * HomeDevA - Apple/Google Marketing Style
 *
 * Key patterns:
...
const HomeDevA: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      icon: Flame,
      title: 'Fire & Smoke',
      description: 'Soot removal, odor elimination, and fire damage restoration.',
    ...
    },
    {
      ...
      description: 'Safe removal, containment, and prevention of mold growth.',
    ...
    },
    {
      icon: Wind,
      title: 'Storm Damage',
      description: 'Emergency tarping, water extraction, and storm restoration.',
  ...
  const testimonials = [
    {
      quote: "Flood Doctor arrived within 45 minutes of my call at 2 AM. They saved our hardwood floors and worked directly with our insurance. Couldn't have asked for better service.",
      author: 'Jennifer M.',
      location: 'Arlington, VA',
      rating: 5,
      project: 'Burst Pipe Restoration'
    },
    {
      quote: "After our basement flooded, I was overwhelmed. The Flood Doctor team took over completely—from water extraction to dealing with our insurance adjuster. True professionals.",
      author: 'Michael R.',
      location: 'Fairfax, VA',
      rating: 5,
    ...
    {
      quote: "The daily updates and moisture readings gave us peace of mind throughout the process. We knew exactly what was happening and when we'd be back to normal.",
      author: 'Sarah K.',
      location: 'McLean, VA',
      rating: 5,
  ...
  const features = [
    {
      ...
      description: 'Track drying progress with our digital dashboard. See moisture levels, equipment status, and estimated completion time—updated daily.',
      visual: 'moisture-dashboard'
    },
    {
      title: 'Direct Insurance Billing',
      description: 'We work with all major insurance carriers and handle the paperwork. You focus on your family—we handle the claim.',
      visual: 'insurance-flow'
    },
    {
      title: 'Certified Technicians',
      description: 'Every technician is IICRC certified, background-checked, and trained in the latest restoration science. Your property is in expert hands.',
  ...
  return (
    <main className="flex-grow bg-white">
      <PageMeta
        ...
        description="24/7 emergency water damage restoration in Northern Virginia. We arrive in 60 minutes. Licensed, insured, and trusted by 10,000+ homeowners."
      />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="text-xl lg:text-2xl text-white/60 mb-10 max-w-xl leading-relaxed">
                Northern Virginia's most trusted restoration company.
                60-minute response, direct insurance billing, zero stress.
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="aspect-[4/3] rounded-3xl bg-gradient-to-br from-slate-700 to-slate-800 overflow-hidden shadow-2xl border border-white/10">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-black/50 backdrop-blur-sm rounded-xl p-4 flex items-center justify-between">
                  <span className="text-white text-sm">Watch how we restore properties</span>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted max-w-2xl mx-auto">
              From emergency water extraction to full reconstruction, we handle every step.
            </p>
          </div>
      ...
      {/* Features - Large Visual Spotlights */}
      <section className="py-24 lg:py-32 bg-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-muted max-w-2xl mx-auto">
              Technology-driven restoration with a personal touch.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-display text-3xl lg:text-4xl font-semibold text-text mb-6">
                Serving Northern Virginia & Washington DC
              </h2>
              <p className="text-lg text-muted leading-relaxed mb-8">
                Our fleet of response vehicles covers all of Northern Virginia with 60-minute response times, 24 hours a day.
              </p>

              <div className="grid grid-cols-2 gap-4 mb-8">
                {['Fairfax', 'Arlington', 'Alexandria', 'McLean', 'Reston', 'Ashburn', 'Loudoun', 'DC Metro'].map((area) => (
      ...
      <section className="py-24 lg:py-32 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/60 mb-10 max-w-2xl mx-auto">
            Get a free assessment and see why thousands of Northern Virginia homeowners trust Flood Doctor.
          </p>
